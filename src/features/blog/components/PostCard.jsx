...
const PostCard = ({ post }) => {
  ...
  return (
    <motion.article
      ...
      className="group cursor-pointer rounded-2xl overflow-hidden border-2 border-light-border-primary dark:border-dark-border-primary bg-light-bg-primary dark:bg-dark-bg-primary shadow-md hover:shadow-xl hover:border-accent transition-all duration-300"
    >
      {/* Featured Image */}
      <div className="relative h-48 overflow-hidden bg-light-bg-secondary dark:bg-dark-bg-secondary">
        {post.featured_image ? (
          ...
          <div className="w-full h-full flex items-center justify-center">
            <svg className="w-16 h-16 text-light-text-tertiary dark:text-dark-text-tertiary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
