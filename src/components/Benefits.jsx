  ...
  const benefits = [
    {
      ...
      title: 'Networking',
      description: 'Accede a una red de expertos en IA de diferentes sectores',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: 'Participa en conferencias, workshops y meetups especializados en IA',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: 'Oportunidades',
      description: 'Participa en proyectos colaborativos y programas de capacitación',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: 'Innovación',
      description: 'Accede a las últimas tendencias y desarrollos en inteligencia artificial',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: 'Obtén acceso a herramientas y plataformas líderes en IA para potenciar tu trabajo',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: 'Visibilidad',
      description: 'Destaca tus proyectos y logros en la comunidad nacional e internacional de IA',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-light-text-secondary dark:text-dark-text-secondary max-w-3xl mx-auto">
            Únete a la Cámara y accede a beneficios exclusivos
          </p>
